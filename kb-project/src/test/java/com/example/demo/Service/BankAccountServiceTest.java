...
class BankAccountServiceTest {
    ...
    void testTransferUsingExistingDatabaseUsers() {
        // Arrange
        String senderAccountNumber = "11"; // Replace with actual sender account number in DB
        String recipientAccountNumber = "1"; // Replace with actual recipient account number in DB
        Long transferAmount = 2L;
